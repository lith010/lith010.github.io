...
a,this.indexDisplay.update(a+1+" / "+this.images.length))}});"export"!==c.contextaction&&(c.isInitialized&&e()||document.observe("xwiki:dom:loading",e),document.observe("xwiki:dom:updated",e));return c}(XWiki||{});
