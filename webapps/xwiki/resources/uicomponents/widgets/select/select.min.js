...
a.selectWidget.find(".xwiki-select-options").append('<p class="xwiki-select-no-results">$escapetool.javascript($escapetool.xml($services.localization.render("web.widgets.select.filter.noResults")))</p>'):a.selectWidget.find(".xwiki-select-no-results").remove()};a.init=function(){a.selectWidget.find(".xwiki-select-option").on("click",a.onOptionClicked);a.selectWidget.find(".xwiki-select-option").on("mouseenter",a.onOptionHovered);a.selectWidget.find(".xwiki-select-options").on("keydown",a.onOptionKeyPressed);
...
this[e];d(a).data("xwikiSelectWidget")||d(a).data("xwikiSelectWidget",new u(a)).attr("data-ready",!0)}else if("clearSelection"==e)for(e=0;e<this.length;++e)d(this[e]).data("xwikiSelectWidget").clearSelection();else if("getValue"==e)return d(this[0]).data("xwikiSelectWidget").getValue();return this};d(function(){d(".xwiki-select").xwikiSelectWidget()})});
