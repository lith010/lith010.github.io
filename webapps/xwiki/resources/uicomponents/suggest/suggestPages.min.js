...
function(d){var k=function(n,h){d(h&&h.elements||document).find(".suggest-pages").suggestPages()};d(document).on("xwiki:dom:loaded xwiki:dom:updated",k);d(k)})}).apply("]]#",$jsontool.serialize([$pageIcon,$webHome]));
