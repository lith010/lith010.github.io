...
new c.widgets.Suggest(a.down("input[type=text]"),{script:"${xwiki.getURL('Main.WebHome', 'view', 'xpage=suggest&classname=XWiki.TagClass&fieldname=tags&firCol=-&secCol=-')}&",parentContainer:"tag-add-form-suggest",varname:"input",seps:"${xwiki.getDocument('XWiki.TagClass').xWikiClass.tags.getProperty('separators').value}",shownoresults:!1,icon:"${xwiki.getSkinFile('icons/silk/tag_yellow.png')}"})}});c.domIsLoaded&&g()||document.observe("xwiki:dom:loaded",g);return c}(XWiki||{});
