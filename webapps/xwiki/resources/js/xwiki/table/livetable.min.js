...
clearDisplay:function(){for(var a=this.displayNode;a.hasChildNodes();)a.removeChild(a.firstChild)},displayRows:function(a,b){b=a+b-1;b>this.totalRows&&(b=this.totalRows);a=0<this.totalRows?a:0;var d="<strong>"+a+"</strong> - <strong>"+b+"</strong> $services.localization.render('platform.livetable.paginationResultsOf') <strong>"+this.totalRows+"</strong>";d=d.toLowerCase();this.limitsDisplays.each(function(e){e.innerHTML="$services.localization.render('platform.livetable.paginationResults') "+d});
