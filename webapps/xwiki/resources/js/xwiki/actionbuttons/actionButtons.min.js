'use strict';var XWiki=function(g){function k(){require(["xwiki-meta"],function(a){r=a.documentReference});new l.EditActions;new l.AjaxSaveAndContinue;return!0}var l=g.actionButtons=g.actionButtons||{},r,t=$("editingVersionDate"),u=$("previousVersion"),y=$("isNew");const z=a=>{"badInput patternMismatch rangeOverflow rangeUnderflow stepMismatch tooLong tooShort typeMismatch valueMissing".split(" ").find(b=>{const c="data-validation-"+b.replace(/([A-Z])/g,d=>`-${d.toLowerCase()}`);if(a.validity[b]&&
a.getAttribute(c)){a.setCustomValidity(a.getAttribute(c));const d=()=>{a.setCustomValidity("");a.removeEventListener("input",d)};a.addEventListener("input",d);return!0}return!1})};document.observe("xwiki:document:changeVersion",function(a){r.equals(a.memo.documentReference)&&(u&&u.setValue(a.memo.version),y&&y.setValue(!1))});l.EditActions=Class.create({initialize:function(){this.addListeners();this.addShortcuts()},addListeners:function(){$$("input[name=action_cancel]").each(function(a){a.observe("click",
this.onCancel.bindAsEventListener(this))}.bind(this));$$("input[name=action_preview]").each(function(a){a.observe("click",this.onSubmit.bindAsEventListener(this,"preview"))}.bind(this));$$("input[name=action_save]").each(function(a){a.observe("click",this.onSubmit.bindAsEventListener(this,"save"))}.bind(this));$$("input[name=action_saveandcontinue]").each(function(a){a.observe("click",this.onSubmit.bindAsEventListener(this,"save",!0))}.bind(this))},addShortcuts:function(){var a={action_cancel:"$services.localization.render('core.shortcuts.edit.cancel')",
action_preview:"$services.localization.render('core.shortcuts.edit.preview')",action_edit:"$services.localization.render('core.shortcuts.edit.backtoedit')",action_inline:"$services.localization.render('core.shortcuts.edit.backtoedit')",action_save:"$services.localization.render('core.shortcuts.edit.saveandview')",action_propupdate:"$services.localization.render('core.shortcuts.edit.saveandview')",action_saveandcontinue:"$services.localization.render('core.shortcuts.edit.saveandcontinue')"},b;for(b in a){var c=
$$("input[name="+b+"]");c.length&&shortcut.add(a[b],function(){this.click()}.bind(c.first()))}},validateForm:function(a){if(a&&!a.checkValidity())return[...a.elements].filter(d=>!d.validity.valid).forEach(z),a.reportValidity(),!1;a=a?.comment||$("commentinput");var b="true"===a?.getAttribute("data-xwiki-edit-comment-suggested");const c="true"===a?.getAttribute("data-xwiki-edit-comment-mandatory");if(b||c)for(;""===a.value;){b=prompt(a.getAttribute("data-xwiki-edit-comment-prompt"),"");if(null===b)return!1;
a.value=b;if(!c)break}return!0},onCancel:function(a){this.notify(a,"cancel")&&(a.preventDefault(),(a=a.element().form)&&this.cancelForm(a))},cancelForm:function(a){var b=a.action||window.location.href;b=b.split("#",2);var c=2==b.length?b[1]:"";b=b[0];-1==b.indexOf("?")&&(b+="?");var d=a.select('input[name="xredirect"]')[0];d=d?"&xredirect="+escape(d.value):"";a=(a=a.select('input[name="language"]')[0])?"&language="+escape(a.value):"";g.EditLock&&g.EditLock.setLocked(!1);window.location=b+"&action_cancel=true"+
d+a+c},onSubmit:function(a,b,c){var d="before"+b.substr(0,1).toUpperCase()+b.substr(1);this.notify(a,d,{"continue":c})&&(this.validateForm(a.element().form)?this.notify(a,b,{"continue":c}):a.preventDefault())},notify:function(a,b,c){(b=a.element().fire("xwiki:actions:"+b,Object.extend({originalEvent:a,form:a.element().form},c||{})).defaultPrevented||a.defaultPrevented)&&a.preventDefault();return!b}});l.AjaxSaveAndContinue=Class.create({initialize:function(){this.createMessages();this.addListeners()},
...
"error",{inactive:!0});this.progressMessageTemplate="$escapetool.javascript($services.localization.render('core.editors.savewithprogress.notification'))";this.progressBox=new g.widgets.Notification(this.progressMessageTemplate.replace("__PROGRESS__","0"),"inprogress",{inactive:!0});this.savedWithMergeBox=new g.widgets.Notification("$escapetool.javascript($services.localization.render('core.editors.saveandcontinue.notification.doneWithMerge'))","done",{inactive:!0})},addListeners:function(){document.observe("xwiki:actions:save",
this.onSave.bindAsEventListener(this))},disableEditors:function(){this._setFormDisabledState(!0)},enableEditors:function(){this._setFormDisabledState(!1)},_setFormDisabledState:function(a){const b=this.form?.querySelector(":scope > fieldset");b?b.disabled=a:a?this.form?.disable():this.form?.enable()},getFormData:function(a){const b=new FormData(this.form);this.hasFormAction(a)&&b.set(a,"");return new URLSearchParams(b)},hasFormAction:function(a){return"string"===typeof a&&[...this.form.querySelectorAll("input[type=submit], button")].some(b=>
b.getAttribute("name")===a)},onSave:function(a){if(!a.defaultPrevented){this.savedBox.hide();this.failedBox.hide();var b=a.memo["continue"];this.form=$(a.memo.form);if(-1!=this.form.action.indexOf("/preview/")||-1!=this.form.action.indexOf("/save/")||b){var c=this.form.template&&this.form.template.value;this.form.async&&"true"===this.form.async.value||(c=!1);a.preventDefault();c?this.progressBox.show():this.savingBox.show();var d="action_save";b&&(d="action_saveandcontinue");d=this.getFormData(d);
b&&d.set("minorEdit","1");Prototype.Browser.Opera||d.set("ajax","true");b||this.disableEditors();a={isContinue:b,isCreateFromTemplate:c,saveButton:a.element()};new Ajax.Request(this.form.action,{method:"post",parameters:d.toString(),onSuccess:this.onSuccess.bind(this,a),on0:this.on0.bind(this),on409:this.on409.bind(this,a),on401:this.on401.bind(this,a),on403:this.on403.bind(this,a),onFailure:this.onFailure.bind(this,a)})}}},on0:function(a){a.request.options.onFailure(a)},onSuccess:function(a,b){this.form&&
this.form.template&&(this.form.template.disabled=!0,this.form.template.value="");$("commentinput")&&($("commentinput").value="");$("forceSave")&&$("forceSave").remove();$$("input[name=mergeChoices]").forEach(function(d){d.remove()});$$("input[name=customChoices]").forEach(function(d){d.remove()});var c=!1;a.isCreateFromTemplate?b.responseJSON&&b.responseJSON.links?this.getStatus(b.responseJSON.links[0].href,a):(this.progressBox.hide(),this.savingBox.replace(this.savedBox),c=!0):(this.progressBox.hide(),
...
p.insert("$services.localization.render('no')");n.insert(p);p.on("click",function(){h.closeDialog()});m.insert(n);return m});a.saveButton.fire("xwiki:document:saveFailed",{response:b})},on409:function(a,b){var c=this;this.progressBox.hide();this.savingBox.hide();this.savedBox.hide();this.failedBox.hide();this.enableEditors();var d=b.responseJSON,m=this.getFormData("preview"),h=function(e,f){var q="diff=1&version="+d.latestVersion;0<$$("input[name=warningConflictAction]").length&&(q+="&warningConflictAction="+
$$("input[name=warningConflictAction]:checked")[0].value);if(e&&f){var w=e;var x=f}else 0<$$("select[name=original]").length&&0<$$("select[name=revised]").length&&(w=$$("select[name=original]")[0].value,x=$$("select[name=revised]")[0].value);w&&x&&(q+="&original="+w+"&revised="+x);e=(new g.Document).getURL("preview",q);new Ajax.Request(e,{method:"post",parameters:m.toString(),onSuccess:A,onFailure:c.onFailure.bind(c,a)})},n=function(){$("forceSave")&&$("forceSave").remove();$$("input[name=mergeChoices]").forEach(function(e){e.remove()});
$$("input[name=customChoices]").forEach(function(e){e.remove()});require(["jquery"],function(e){var f=e("input[name=warningConflictAction]:checked").val();B().map(C);e("#previewDiffModal").modal("hide");"reload"===f?c.reloadEditor():(c.form.insert(new Element("input",{type:"hidden",name:"forceSave",id:"forceSave",value:f})),a.isContinue?e("input[name=action_saveandcontinue]").click():e("input[name=action_save]").click())})},p=function(){require(["jquery"],function(e){e("input[name=warningConflictAction]").parents(".panel").removeClass("panel-primary");
e("input[name=warningConflictAction]").parents(".panel").addClass("panel-default");e("input[name=warningConflictAction]:checked").parents(".panel").addClass("panel-primary")})},v=function(e){require(["jquery"],function(f){f(e.currentTarget).find("input[name=warningConflictAction]").click()})},D=function(){var e=$$("input[name=warningConflictAction]:checked")[0].value;"merge"==e?h("NEXT","MERGED"):"override"==e||"custom"==e?h("NEXT","CURRENT"):"reload"==e&&h("CURRENT","NEXT")},B=function(){return $$("input[name=conflict_id]").map(function(e){return e.value})},
C=function(e){var f=$("conflict_decision_select_"+e).value,q=$("conflict_decision_value_custom_"+e).value;c.form.insert(new Element("input",{type:"hidden",name:"mergeChoices",id:"mergeChoices_"+e,value:e+"="+f}));"custom"===f&&c.form.insert(new Element("input",{type:"hidden",name:"customChoices",id:"custom_"+e,value:e+"="+encodeURI(q)}))};var A=function(e){require(["jquery"],function(f){f("#previewDiffModal")&&(f("#previewDiffChangeDiff").off("click"),f("input[name=warningConflictAction]").off("click"),
f("#submitDiffButton").off("click"),f("#previewDiffModal").remove(),f("div.modal-backdrop").remove());f(e.responseText).appendTo("body");p();f("#previewDiffModal").modal("show");f("#previewDiffModal").on("hidden.bs.modal",function(q){f("#previewDiffModal").remove();f("div.modal-backdrop").remove()});f("#previewDiffChoices .panel").on("click",v);f("input[name=warningConflictAction]").on("change",D);f("#previewDiffChangeDiff").on("click",h);f("#submitDiffButton").on("click",n);f(document).trigger("xwiki:dom:updated",
{elements:f("#previewDiffModal").toArray()})})};h();a.saveButton.fire("xwiki:document:saveFailed",{response:b})},onFailure:function(a,b){this.enableEditors();this.savingBox.replace(this.failedBox);this.progressBox.replace(this.failedBox);b.statusText?b.getHeader("Content-Type").match(/^\s*text\/plain/)?$("ajaxRequestFailureReason").update(b.responseText):$("ajaxRequestFailureReason").update(b.statusText):$("ajaxRequestFailureReason").update("Server not responding");a.saveButton.fire("xwiki:document:saveFailed",
{response:b})},startStatusReport:function(a){updateStatus(0)},getStatus:function(a,b){new Ajax.Request(a,{method:"get",parameters:{media:"json"},onSuccess:function(c){c=c.responseJSON.progress.offset;this.updateStatus(c);1>c?setTimeout(this.getStatus.bind(this,a,b),1E3):(this.progressBox.replace(this.savedBox),this.maybeRedirect(b.isContinue))}.bind(this),on0:this.on0.bind(this),onFailure:this.onFailure.bind(this,b)})},updateStatus:function(a){a=""+100*a;var b=a.indexOf(".");-1<b&&(a=a.substring(0,
b+2));a=new g.widgets.Notification(this.progressMessageTemplate.replace("__PROGRESS__",a),"inprogress");this.progressBox.replace(a);this.progressBox=a},maybeRedirect:function(a){if(a)if($("body").hasClassName("previewbody"))a=g.currentDocument.getURL("edit"),this.form.xcontinue&&this.form.xcontinue.value&&(a=this.form.xcontinue.value);else return!1;else{a=g.currentDocument.getURL();var b=this.form.select('input[name="xredirect"]')[0];b&&b.value&&(a=b.value)}a&&(window.location=a);return!0}});g.domIsLoaded&&
k()||document.observe("xwiki:dom:loaded",k);return g}(XWiki||{});
