...
#end
#[[*/
'use strict';(function(h){require(["jquery","xwiki-syntax-converter","bootstrap"],function(d,l){d(document).on("change.xwikiDocumentSyntaxPicker","#xwikidocsyntaxinput2",function(){var b=d(this),e=b.data("previousSyntax"),g=a(b);k(e,g).then(m=>{b.focus();f(b,{previousSyntax:e,syntax:g,convertSyntax:m.convertSyntax})})});var a=function(b){b=b.find("option").filter(":selected");return d.extend(b.data("syntax"),{id:b.val(),label:b.text(),parser:b.data("parser"),renderer:b.data("renderer")})},f=function(b,
...
"error"))})}})})}).apply("]]#",$jsontool.serialize([$l10n]));
